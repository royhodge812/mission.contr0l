...
export const RocketIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
    <path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.3.05-3.05-.64-.75-2.15-.8-3.05-.05z"></path>
...
export const BrainCircuitIcon: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M18.42 15.5a3 3 0 1 0-5.993-.142"></path>
        <path d="M13.58 8.5a3 3 0 1 0 5.993.142"></path>
        <path d="M6.007 8.142A3 3 0 1 0 9 5"></path>
        <path d="M14.58 15.5a3 3 0 1 0 2.815-1.58"></path>
        <path d="M6.142 12.007A3 3 0 1 0 9 15"></path>
        <path d="M12 7V5"></path><path d="M10.035 6.465 9 5"></path>
        <path d="M13.965 6.465 15 5"></path><path d="M12 13v-2"></path>
        <path d="M12 21v-2"></path><path d="M15 17h-2"></path>
        <path d="M18 13h-2"></path><path d="M15 11h-2"></path>
        <path d="M9 17H7"></path><path d="M9 13H7"></path>
        <path d="M9 9H7"></path>
    </svg>
);
